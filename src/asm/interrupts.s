...
interrupt_handler:
    ...
    #Save at and coprocessor1 registers. Use the stack pointer because a
...
interrupt_dispatch:                 # Interrupt:
    ...
    and     $k1, $k0, BONK_INT_MASK     # is there a bonk interrupt?
    bne     $k1, 0, bonk_interrupt

    and     $k1, $k0, TIMER_INT_MASK    # is there a timer interrupt?
