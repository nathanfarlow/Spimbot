...
nw = [
    Node((15 * 8, 11 * 8 + 4), c, [(7, 7), (14, 14)], [(40 * 8 - 15 * 8, 40 * 8 - (11 * 8 + 4))]),
    Node(topix(8, 8), none, [(7, 7), (5, 13), (13, 5)], angle_adj = [0, 5, -5]),
    Node((12 * 8, 14 * 8 + 4), cc, [(7, 7), (14, 14)], [(40 * 8 - 12 * 8, 40 * 8 - (14 * 8 + 4))])
]

sw = [
    Node((14 * 8 + 6, 24 * 8), c, [(12, 27), (14, 14), (25, 25)], [(18 * 8, 18 * 8 + 4), (40 * 8 - 17 * 8, 40 * 8 - (25 * 8 + 2))], angle_adj = [7, 0, 0]),
