...
sw = [
    Node((15 * 8, 23 * 8 + 4), c, [(12, 27), (14, 14), (25, 25)], [(18 * 8, 18 * 8 + 4), (40 * 8 - 17 * 8, 40 * 8 - (25 * 8 + 2))], angle_adj = [8, 0, 0]),
    Node((9 * 8, 29 * 8), none, [(12, 27), (2, 26), (13, 37)]),
    Node((7 * 8, 29 * 8), none, [(6, 33), (2, 26), (12, 27)]),
    Node((9 * 8, 29 * 8), none, [(12, 27), (2, 26), (13, 37)]),
    Node((17 * 8, 25 * 8 + 2), cc, [(12, 27), (14, 14), (25, 25)], [(22 * 8, 21 * 8 + 4), (40 * 8 - (15 * 8), 40 * 8 - (23 * 8 + 4))], angle_adj = [0, -2, 0])
]
